...
GO
PRINT N'Creating Table [dbo].[ItemOpitons]...';


GO
CREATE TABLE [dbo].[ItemOpitons] (
    [ItemId]   INT NOT NULL,
    [OptionId] INT NOT NULL,
    PRIMARY KEY CLUSTERED ([ItemId] ASC, [OptionId] ASC)
);


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[ItemOpitons]...';


GO
ALTER TABLE [dbo].[ItemOpitons] WITH NOCHECK
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.ItemOpitons'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
