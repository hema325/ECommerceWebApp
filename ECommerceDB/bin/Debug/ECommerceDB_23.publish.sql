...
GO
/*
The column [dbo].[WishLists].[Id] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[WishLists])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping Foreign Key unnamed constraint on [dbo].[WishLists]...';


GO
ALTER TABLE [dbo].[WishLists] DROP CONSTRAINT [FK__WishLists__UserI__7C1A6C5A];
...
GO
ALTER TABLE [dbo].[WishLists] DROP CONSTRAINT [FK__WishLists__ItemI__7D0E9093];


GO
PRINT N'Dropping Unique Constraint unnamed constraint on [dbo].[WishLists]...';


GO
ALTER TABLE [dbo].[WishLists] DROP CONSTRAINT [UQ__tmp_ms_x__B0AF247526267AB3];


GO
PRINT N'Starting rebuilding table [dbo].[WishLists]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_WishLists] (
    [UserId] INT NOT NULL,
    [ItemId] INT NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[WishLists])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_WishLists] ([UserId], [ItemId])
        SELECT   [UserId],
                 [ItemId]
        FROM     [dbo].[WishLists]
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_WishLists]', N'WishLists';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[WishLists]...';


GO
ALTER TABLE [dbo].[WishLists] WITH NOCHECK
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.WishLists'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.ItemOptions'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Products'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
