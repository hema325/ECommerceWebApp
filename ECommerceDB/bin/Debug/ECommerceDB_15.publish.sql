...
GO
/*
The column [dbo].[Discounts].[ProductId] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Discounts])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping Foreign Key unnamed constraint on [dbo].[Discounts]...';


GO
ALTER TABLE [dbo].[Discounts] DROP CONSTRAINT [FK__Discounts__Produ__29221CFB];


GO
PRINT N'Altering Table [dbo].[Discounts]...';


GO
ALTER TABLE [dbo].[Discounts] DROP COLUMN [ProductId];
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.ItemOptions'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
