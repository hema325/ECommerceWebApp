...
GO
PRINT N'Creating Table [dbo].[Variations]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Variations]...';


GO
ALTER TABLE [dbo].[Variations] WITH NOCHECK
    ADD FOREIGN KEY ([CategoryId]) REFERENCES [dbo].[Categories] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Variations'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
