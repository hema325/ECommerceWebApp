...
GO
PRINT N'Dropping Unique Constraint unnamed constraint on [dbo].[Countries]...';


GO
ALTER TABLE [dbo].[Countries] DROP CONSTRAINT [UQ__Countrie__737584F68C374B5E];
...
GO
ALTER TABLE [dbo].[Countries] ALTER COLUMN [Name] VARCHAR (24) NOT NULL;


GO
PRINT N'Creating Unique Constraint unnamed constraint on [dbo].[Countries]...';
