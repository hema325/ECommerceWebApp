...
GO
PRINT N'Dropping Unique Constraint unnamed constraint on [dbo].[Categories]...';


GO
ALTER TABLE [dbo].[Categories] DROP CONSTRAINT [UQ__Categori__737584F63C57EE7A];


GO
PRINT N'Creating Table [dbo].[WishLists]...';
