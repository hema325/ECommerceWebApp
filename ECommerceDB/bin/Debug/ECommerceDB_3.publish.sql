...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Products'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
