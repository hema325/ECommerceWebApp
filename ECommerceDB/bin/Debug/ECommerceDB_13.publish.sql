...
GO
/*
The column [dbo].[Items].[Discount] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Altering Table [dbo].[Items]...';


GO
ALTER TABLE [dbo].[Items] DROP COLUMN [Discount];


GO
PRINT N'Creating Table [dbo].[Discounts]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Discounts]...';


GO
ALTER TABLE [dbo].[Discounts] WITH NOCHECK
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Discounts'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.ItemOptions'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
