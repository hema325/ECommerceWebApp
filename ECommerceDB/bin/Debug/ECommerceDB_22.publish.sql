...
GO
ALTER TABLE [dbo].[WishLists] DROP CONSTRAINT [FK__WishLists__UserI__76619304];
...
GO
ALTER TABLE [dbo].[WishLists] DROP CONSTRAINT [FK__WishLists__ItemI__7755B73D];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[WishLists])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_WishLists] ON;
        INSERT INTO [dbo].[tmp_ms_xx_WishLists] ([Id], [UserId], [ItemId])
        SELECT   [Id],
                 [UserId],
                 [ItemId]
        FROM     [dbo].[WishLists]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_WishLists] OFF;
    END
