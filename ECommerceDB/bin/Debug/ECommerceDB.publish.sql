...
GO
PRINT N'Creating Index [dbo].[messages].[idx_messagesIsRead]...';


GO
CREATE NONCLUSTERED INDEX [idx_messagesIsRead]
    ON [dbo].[Messages]([IsRead] ASC);


GO
PRINT N'Creating Index [dbo].[messages].[idx_messagesSenderId]...';


GO
CREATE NONCLUSTERED INDEX [idx_messagesSenderId]
    ON [dbo].[Messages]([SenderId] ASC);


GO
PRINT N'Creating Index [dbo].[messages].[idx_messagesConversationId]...';


GO
CREATE NONCLUSTERED INDEX [idx_messagesConversationId]
...
GO
PRINT N'Creating Table [dbo].[Tokens]...';
...
GO
PRINT N'Creating Table [dbo].[UserConversations]...';
...
CREATE TABLE [dbo].[UserConversations] (
    [UserId]         INT           NOT NULL,
    [ConversationId] INT           NOT NULL,
    [JoinDateTime]   DATETIME2 (0) NULL,
    [LeftDateTime]   DATETIME2 (0) NULL,
    PRIMARY KEY CLUSTERED ([UserId] ASC, [ConversationId] ASC)
);


GO
PRINT N'Creating Index [dbo].[userConversations].[Idx_userConversationsJoinDateTime]...';


GO
CREATE NONCLUSTERED INDEX [Idx_userConversationsJoinDateTime]
    ON [dbo].[UserConversations]([JoinDateTime] ASC);


GO
PRINT N'Creating Index [dbo].[userConversations].[Idx_userConversationsLeftDateTime]...';


GO
CREATE NONCLUSTERED INDEX [Idx_userConversationsLeftDateTime]
    ON [dbo].[UserConversations]([LeftDateTime] ASC);
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Conversations]...';


GO
ALTER TABLE [dbo].[Conversations]
    ADD FOREIGN KEY ([LastMessageId]) REFERENCES [dbo].[Messages] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE [dbo].[Messages]
    ADD FOREIGN KEY ([SenderId]) REFERENCES [dbo].[Users] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
GO
ALTER TABLE [dbo].[UserConversations]
    ADD FOREIGN KEY ([UserId]) REFERENCES [dbo].[Users] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
