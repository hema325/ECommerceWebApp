...
GO
PRINT N'Creating Table [dbo].[ProductDiscounts]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[ProductDiscounts]...';


GO
ALTER TABLE [dbo].[ProductDiscounts] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[ProductDiscounts] WITH NOCHECK
    ADD FOREIGN KEY ([DiscountId]) REFERENCES [dbo].[Discounts] ([Id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.ProductDiscounts'), OBJECT_ID(N'dbo.Categories'), OBJECT_ID(N'dbo.ItemOptions'), OBJECT_ID(N'dbo.Messages'), OBJECT_ID(N'dbo.Tokens'), OBJECT_ID(N'dbo.UserConversations'), OBJECT_ID(N'dbo.UserRoles'))
               AND [type] IN (N'F', N'C')
